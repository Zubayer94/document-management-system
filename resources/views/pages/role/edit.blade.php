                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group text-left">
                                            ...
                                            <input id="name" class="form-control @error('name') is-invalid @enderror"
                                                ...
                                                @else value="{{ $role->name }}" @endif placeholder="Role Name" required/>
                                            @error('name')
                                                            ...
                                                            <div class="form-group m-0">
                                                                @foreach($values as $val)
                                                                    <label class="d-block m-0">
                                                                        <input type="checkbox" class="{{ str_replace(' ', '', $val['module_name']) }}" name="permissions[]" value="{{ $val['name'] }}" @if(in_array($val['name'], $rolePermissions)) checked @endif> {{ $val['name'] }}
                                                                    </label>
                                                                @endforeach
                                                            </div>
                                                        </div>
